...
ADMIN_FUNC_KEYWORDS = {
    # AC-001: Unvalidated access to Admin/Governance Updates (callable by anyone)
    ...
    # AC-003: Unvalidated access to Flashloan/Callback Entrypoints (Without Caller Validation)
...
def run(sl:Slither):
    ...
    state_meta = {}    # Maps functions -> [ admin_state_var ] being updated
